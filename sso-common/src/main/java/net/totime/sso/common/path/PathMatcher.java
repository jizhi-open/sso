package net.totime.sso.common.path;
 ...
 *
 * @author Apache Ant
 * <p>The default implementation is {@link net.totime.sso.common.path.PathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
